...
export const WETH_ADDRESS = Bytes.fromHexString(
...
export const ACTIVE_POOL_CREATED_BLOCK = BigInt.fromI32(9129672);
export const ACTIVE_POOL_CREATED_TIMESTAMP = BigInt.fromI32(1686026808);
